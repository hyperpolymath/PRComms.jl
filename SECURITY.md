...
============================================================================
Replace all PRComms.jl values with your information:
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/PRComms.jl/security/advisories/new)
...
- This repository (`hyperpolymath/PRComms.jl`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/PRComms.jl/security/advisories)
...
When using PRComms.Jl, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/PRComms.jl/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/PRComms.jl/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/PRComms.jl/discussions) |
...
*Thank you for helping keep PRComms.Jl and its users safe.* 🛡️
