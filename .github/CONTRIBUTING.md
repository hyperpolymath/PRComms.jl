...
git clone <https://github.com/hyperpolymath/PRComms.jl.git> cd
PRComms.jl
...
toolbox create PRComms.jl-dev toolbox enter PRComms.jl-dev \# Install
...
PRComms.jl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/PRComms.jl/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/PRComms.jl/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/PRComms.jl/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/PRComms.jl/labels/perimeter-3) — Community sandbox scope
