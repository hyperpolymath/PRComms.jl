...
|===
|Placeholder |Description |Example |Files
|`+PRComms.Jl+` |Human-readable project name |`+My Project+`
...
|`+PRComms.jl+` |Uppercase identifier (for Idris2 modules, C macros)
...
|`+PRComms.jl+` |Repository name (slug) |`+my-project+`
...
|`+PRComms.jl+` |One-line project description
