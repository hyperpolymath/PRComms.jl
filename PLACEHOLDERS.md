...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `PRComms.Jl` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.nix, devcontainer.json |
| `PRComms.jl` | One-line description | `A tool for X` | flake.nix |
