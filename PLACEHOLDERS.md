...
All placeholders in this template follow the `PRComms.jl` pattern.
...
sed -i 's/PRComms.Jl/my-project/g' $(grep -rl 'PRComms.Jl' .)
sed -i 's/PRComms.jl/MY_PROJECT/g' $(grep -rl 'PRComms.jl' .)
...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `PRComms.Jl` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.guix, devcontainer.json |
| `PRComms.jl` | One-line description | `A tool for X` | flake.guix |
| `PRComms.jl` | Uppercase identifier (for Idris2 modules, C macros) | `MY_PROJECT` | ABI-FFI-README.md, src/abi/*.idr, ffi/zig/*.zig |
| `{{project}}` | Lowercase identifier (for C symbols, filenames) | `my_project` | ABI-FFI-README.md, ffi/zig/*.zig |
| `PRComms.jl` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
...
| `PRComms.jl` | One-line project description | `FFI bridges between languages` | STATE.a2ml |
